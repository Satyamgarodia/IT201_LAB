...
public class IT201 {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1 -> q1a.main(args);
                case 2 -> q1b.main(args);
                case 3 -> q3.main(args);
                case 4 -> q4.main(args);
                case 5 -> q5.main(args);
                case 6 -> q6.main(args);
                ...
                case 15 -> q2a.main(args);
                case 16 -> q2b.main(args);
                case 17 -> q2c.main(args);
                case 18 -> q2d.main(args);
                case 19 -> q3a.main(args);
                case 20 -> q20.main(args);
                case 21 -> q3b.main(args);
                case 22 -> q4a.main(args);
                case 23 -> q4b.main(args);
                case 24 -> q4c.main(args);
                case 25 -> q25.main(args);
                case 26 -> q26.main(args);
                case 27 -> q5b.main(args);
                case 28 -> q5a.main(args);
                case 29 -> q6a.main(args);
